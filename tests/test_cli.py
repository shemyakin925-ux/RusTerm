...
def test_cli_full_cycle_init_ingest_snapshot_export_verify_doctor(capsys):
    ...
    try:
        ...
        assert "schema_version=42" in out
        ...
        assert report["schema_version"] == 42
    finally:
        shutil.rmtree(root)
...
def test_cli_doctor_reports_schema_drift(capsys):
    ...
    try:
        ...
        assert any("schema_version=36" in p and "42" in p
...
def test_cli_doctor_reports_schema_drift_38(capsys):
    ...
    try:
        ...
        assert any("schema_version=37" in p and "42" in p
                   for p in report["problems"])
    finally:
        shutil.rmtree(root)
...
def test_cli_doctor_reports_schema_drift_39(capsys):
    ...
    try:
        ...
        assert any("schema_version=38" in p and "42" in p
                   for p in report["problems"])
    finally:
        shutil.rmtree(root)
...
def test_cli_doctor_reports_schema_drift_40(capsys):
    ...
    try:
        ...
        assert any("schema_version=39" in p and "42" in p
                   for p in report["problems"])
    finally:
        shutil.rmtree(root)
