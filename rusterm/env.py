...
То же касается каталога данных (ТЗ-81 B3): запуск двойным щелчком —
это пустое окружение, и без файла окно открыло бы ~/.rusterm, а не
рабочую базу пользователя.
...
строки и комментарии пропускаются, имена вне нашего списка
игнорируются. Значения никогда не печатаются, не логируются и не
пишутся в аудит — наружу идут только имена и происхождение.
"""
