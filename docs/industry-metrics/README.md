...
## Уже описанные отрасли

| Отрасль | Файл | Готовность |
|---|---|---|
| Maritime / Tanker | `maritime-tanker.md` | Шаблон |
| Maritime / Container | `maritime-container.md` | Шаблон |
| Maritime / Bulk | `maritime-bulk.md` | Шаблон |
| Banks | `banks.md` | Шаблон |
| Insurance | `insurance.md` | Шаблон |
| REITs | `reits.md` | Шаблон |
| Telecom | `telecom.md` | Шаблон |
| Utilities (regulated) | `utilities.md` | Шаблон |
| Airlines | `airlines.md` | Шаблон |
| Oil & Gas (upstream) | `oil-gas-upstream.md` | Шаблон |
| Oil & Gas (integrated) | `oil-gas-integrated.md` | Шаблон |
| Mining (gold) | `mining-gold.md` | Шаблон |
| Mining (copper) | `mining-copper.md` | Шаблон |
| Mining (iron ore) | `mining-iron-ore.md` | Шаблон |
| Big Tech | `big-tech.md` | Шаблон |

---

## Maritime / Tanker (подробный пример)
